...
-file("/Users/seancallan/.asdf/installs/erlang/25.0/lib/parsetools-2.4/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_8(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_indices(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
yeccpars2_10(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_indices(hd(Nss), Cat, Nss, NewStack, T, Ts, Tzr).
...
yeccgoto_group(0=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_3(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_group(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_3(_S, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_indices/7}).
-compile({nowarn_unused_function,  yeccgoto_indices/7}).
yeccgoto_indices(4, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_6(6, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_indices(11, Cat, Ss, Stack, T, Ts, Tzr) ->
...
-file("src/cs_parser.yrl", 11).
yeccpars2_10_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                         unwrap_range(___1, ___3)
  end | __Stack].

-compile({inline,yeccpars2_12_/1}).
-dialyzer({nowarn_function, yeccpars2_12_/1}).
-compile({nowarn_unused_function,  yeccpars2_12_/1}).
-file("src/cs_parser.yrl", 8).
