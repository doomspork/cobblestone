-file("/Users/seancallan/.asdf/installs/erlang/25.0/lib/parsetools-2.4/include/leexinc.hrl", 0).
...
-file("src/cs_lexer.xrl", 16).

-file("/Users/seancallan/.asdf/installs/erlang/25.0/lib/parsetools-2.4/include/leexinc.hrl", 14).
...
-file("src/cs_lexer.xrl", 6).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/cs_lexer.xrl", 7).
yyaction_1(TokenChars, TokenLine) ->
     { token, { var, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/1}).
-file("src/cs_lexer.xrl", 8).
yyaction_2(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/cs_lexer.xrl", 9).
yyaction_3(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/cs_lexer.xrl", 10).
yyaction_4(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/cs_lexer.xrl", 11).
yyaction_5(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_6/0}).
-file("src/cs_lexer.xrl", 12).
yyaction_6() ->
     skip_token .

-file("/Users/seancallan/.asdf/installs/erlang/25.0/lib/parsetools-2.4/include/leexinc.hrl", 313).
